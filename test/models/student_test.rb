...
class StudentTest < ActiveSupport::TestCase
  ...
  test "should raise error when saving student without first name" do
    assert_raises ActiveRecord::RecordInvalid do
        Student.create!(last_name: "Schwemby", school_email: "test@msudenver.edu", major: "CS", graduation_date: "2024-12-16" )
    end
  end

  test "should raise error when saving student without last name" do
    assert_raises ActiveRecord::RecordInvalid do
      Student.create!(first_name: "Eric", school_email: "test@msudenver.edu", major: "CS", graduation_date: "2024-12-16")
    end
  end
  ...
  test "should raise error when saving student without major" do
    assert_raises ActiveRecord::RecordInvalid do
      Student.create!(first_name: "Eric", last_name: "Schwemby", school_email: "test@msudenver.edu", graduation_date: "2024-12-16")
    end
  end

  test "should not raise error when saving student with valid data" do
    assert_nothing_raised do
      Student.create!(first_name: "Eric", last_name: "Schwemby", school_email: "test@msudenver.edu", major: "CS", graduation_date: "2024-12-16")
    end
  end
  ...
  test "should raise error when student with duplicate email is submitted" do
    students(:one)
    assert_raises ActiveRecord::RecordInvalid do
      Student.create!(first_name: "Eric", last_name: "Schwemby", school_email: "pparker@msudenver.edu", major: "CS", graduation_date: "2024-12-16")
    end
  end

  test "should display error when student with duplicate email is submitted" do
    students(:one)
    student = Student.create(first_name: "Eric", last_name: "Schwemby", school_email: "pparker@msudenver.edu", major: "CS", graduation_date: "2024-12-16")
    assert_includes student.errors[:school_email], "has already been taken"
  end

  test "should raise error when student with improper email format is submitted" do
    assert_raises ActiveRecord::RecordInvalid do
      Student.create!(first_name: "Eric", last_name: "Schwemby", school_email: "ericemail.com", major: "CS", graduation_date: "2024-12-16")
    end
  end

  test "should raise error when student with non musenver.edu email is submitted" do
    assert_raises ActiveRecord::RecordInvalid do
      Student.create!(first_name: "Eric", last_name: "Schwemby", school_email: "ericemail@gmail.com", major: "CS", graduation_date: "2024-12-16")
    end
  end

  test "should display error when student with invalid email format is submitted" do
    student = Student.create(first_name: "Eric", last_name: "Schwemby", school_email: "ericemail.com", major: "CS", graduation_date: "2024-12-16")
    assert_includes student.errors[:school_email], "not a valid msu email address"
  end
  ...
  test "should attach profile picture" do
    student = Student.new(first_name: "Eric", last_name: "Schwemby", school_email: "eric@msudenver.edu", major: "CS", graduation_date: "2024-12-16")
